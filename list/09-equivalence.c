// 參考 Fundamentals of data structures in c 2nd edition 第 177 頁
#include <stdio.h>
#include <stdlib.h>
#define MAX_SIZE 24

enum boolean { FALSE, TRUE };
typedef enum boolean bool1;
            ...
            for (;;) {
                ...
                */
                ...
                if (!top) {
                    ...
                    // top->data 會儲存在這個 "equivalence" 中的值
                    x = seq[top->data];
                    // top->next 會儲存上一個 top 值
                    top = top->next;
                    // 可以回翻上一步的程式碼，應該能理解
                    // 我是覺得不太好理解了，我自己看了很多遍
                }
